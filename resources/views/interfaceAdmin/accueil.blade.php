        ...
        <div class="page-admin">
            ...
            <div class="contenu">
                ...
                <section class="section-index-admin">
                    ...
                    <div class="boutons">
                        <a class="bouton" href="liste-commandes.html">Afficher les commandes</a>
                    </div>
                ...
                <section class="section-index-admin">
                    ...
                    <h4>Articles</h4>
                    <div class="boutons">
                        <a class="bouton" href="liste-articles.html">Gérer les articles</a>
                        <a class="bouton" href="ajouter-article.html">Ajouter un article</a>
                    </div>
